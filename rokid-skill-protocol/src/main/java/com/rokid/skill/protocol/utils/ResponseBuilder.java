...
public class ResponseBuilder {
     ...
     * 发起confirm
     */
    public ResponseBuilder confirmOpen(String confirmIntent, String confirmSlot,
     ...
     * 播放上一首
     */
    public ResponseBuilder mediaPrevious() {
        if (resMedia == null) {
            resMedia = new ResMedia();
        }
        resMedia.setAction(ResMedia.MEDIA_ACTION_previous);
        return this;
    }
    /**
     * 播放下一首
     */
    public ResponseBuilder mediaNext() {
        if (resMedia == null) {
            resMedia = new ResMedia();
        }
        resMedia.setAction(ResMedia.MEDIA_ACTION_NEXT);
        return this;
    }
